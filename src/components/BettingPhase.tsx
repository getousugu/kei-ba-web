          ...
          {horses.map(h => {
            ...
            return (
              <div key={h.horse_number} onClick={() => canSel && handleHorseSelect(h.horse_number)}
                ...
                <div className="absolute right-3 top-3 rounded border border-amber-400/15 bg-[#1e1e24]/95 px-2 py-1 text-right">
                  <div className="text-[8px] font-black tracking-widest text-amber-500/60">獲得賞金</div>
                  <div className="font-mono text-[10px] font-black tabular-nums text-amber-200">
