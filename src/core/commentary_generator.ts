...
export class CommentaryGenerator {
  private static PHRASES: Record<string, string[]> = {
    ...
    DRAMA_PACK_COMPRESSION: [
      "🎬 馬群が一気に凝縮した！ここから何かが起きそうです！！",
      "🎬 前後の差が詰まった！各馬が勝負圏内へ入ってきます！！",
      "🎬 ひとかたまりで勝負どころへ！進路ひとつで明暗が分かれそうです！！"
    ],
    DRAMA_LATE_CHARGE: [
      "🎬 後ろから{name}が迫る！一気に主役へ躍り出るか！！",
      "🎬 {name}が急浮上！前の馬たちへ強烈な圧力をかけます！！",
      "🎬 来た来た{name}！溜めていた脚を見せ始めました！！"
    ],
    DRAMA_ESCAPE_TENSION: [
      "🎬 {name}が後続を引き離す！このリードを守り切れるか！！",
      "🎬 逃げる{name}、一人旅に持ち込んだ！後続は間に合うでしょうか！！",
      "🎬 {name}が大きく前へ！追う馬たちにも焦りが見えます！！"
    ],
    DRAMA_HEAD_TO_HEAD: [
      "🎬 二頭が互いを意識して譲らない！叩き合いの様相です！！",
      "🎬 並んだ、また並び返す！先頭争いから目が離せません！！",
      "🎬 一完歩ごとに優勢が変わる！二頭の意地がぶつかります！！"
    ],
    DRAMA_SECOND_WIND: [
      "🎬 {name}がもうひと伸び！一度は止まった脚を動かします！！",
      "🎬 {name}が差し返そうとする！まだ勝負を諦めていません！！",
      "🎬 ここで{name}が再加速！もう一度前を追います！！"
    ],
    CROWD_ROAR: [
      "🔊 スタンドからは地鳴りのような大歓声！！",
      "🔊 場内の熱気が最高潮に達しています！！",
