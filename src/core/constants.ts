...
export const TITLES: TitleDefinition[] = [
  ...
  { id: 'photo_witness', name: '写真判定の目撃者', description: '写真判定となったレースを最後まで見届けた', color: 'text-cyan-300' },
  { id: 'photo_sniper', name: 'ハナ差の射手', description: '写真判定となったレースで馬券を的中させた', color: 'text-sky-400' },
  { id: 'trifecta_master', name: '三連単の設計者', description: '3連単を順番どおりに的中させた', color: 'text-violet-400' },
  { id: 'comeback_believer', name: '豪脚を信じた者', description: '中盤で7番手以下だった勝ち馬の単勝を的中させた', color: 'text-rose-400' },
  { id: 'clean_sweep', name: '馬券の万能家', description: '1レースで3種類以上の券種を的中させた', color: 'text-emerald-300' },
